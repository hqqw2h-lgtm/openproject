...
RSpec.describe OAuth::Applications::IndexComponent, type: :component do
  ...
  context "with applications" do
    ...
    it "does not render the empty state in the other-applications list" do
      expect(rendered_component).to have_no_css("#op-admin-oauth--other-applications .blankslate")
    end
  end
